...
//                }
            ...
            VStack(spacing: 20){
                ...
                VStack(spacing: 8){
                    ...
                    Text("Model: Japan HW Author: Kumekovaaa Model's Link: https://sketchfab.com/3d-models/japan-hw-c3d60d0e25224ea592e87425a2f3b130 License: CC BY 4.0 — Creative Commons Attribution Link da licença: https://creativecommons.org/licenses/by/4.0/")
                        .font(.system(size: 13, weight: .regular))
                        .frame(width: 361, alignment: .leading)
                }
                .padding(.horizontal)
